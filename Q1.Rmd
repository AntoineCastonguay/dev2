...
C_RVector3 <- function(t, vars, parms){
  with(as.list(c(parms, vars)), {
    # Modèle consommateur ressoure
    dR <- alpha*R*(1-R/1750) - beta*R*C # dR/dt
    dC <- gamma*R*C - sigma*C  # dC/dt
...
dessinSol(parms = c(alpha=0.17,beta=0.0242,gamma=0.0295,sigma=0.401),func = C_RVector3)
dessinSol(parms = c(alpha=0.17,beta=0.0242,gamma=0.02928,sigma=0.401),func = C_RVector2)
